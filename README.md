...
> **Note**: This is the main documentation file. Additional technical documentation, fixes, and development notes are organized locally in the `docs/` folder (not version controlled).
